...
interface HabitRepository {
    ...
    fun observeChecked(habitId: Long, date: LocalDate): Flow<Boolean>

    /** 近 [days] 天完成情况（§5.4 统计数据来源，每天一个条目，未打卡=false） */
    fun observeCompletionStats(habitId: Long, days: Int): Flow<List<Pair<LocalDate, Boolean>>>
    ...
    /** 撤销打卡 = 删除当日记录（§5.2） */
    suspend fun checkOut(habitId: Long, date: LocalDate)
}
